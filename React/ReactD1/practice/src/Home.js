            ...
            <div className="container main-body">
                <div className="row">
                    ...
                    <div className="col-md-7 main-body-text">
                        <div className="main-body-text-1">
                            Hi, my name is
                        </div>
                        <div className="main-body-text-2">
                            Anne Sullivan
                        </div>
                        <div className="main-body-text-3">
                            I build things for the web
                        </div>
                        <div className="get-in-touch">
                            <button type="button" onclick="window.location.href= 'about-me.html'" class="btn btn-get-in-touch">Get In Touch</button>
                        </div>
                    </div>
                </div>
            </div>
